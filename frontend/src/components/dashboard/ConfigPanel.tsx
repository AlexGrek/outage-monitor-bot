            ...
            <div className="flex-1 min-w-0 mr-4">
              ...
              {editingKey === key ? (
                <input
                  ...
                  className="mt-1 w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  autoFocus
                />
              ) : (
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 truncate">{value}</p>
              )}
            </div>
            <div className="flex items-center gap-2">
              {editingKey === key ? (
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm font-medium text-primary-600 hover:text-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-md transition-colors"
                >
                  Edit
                </button>
              )}
